...
function ViewProductCategories() {
  ...
  const handleSearch = (event) => {
    ...
    if (allProductCategories) {
      const filtered = allProductCategories.filter((item) =>
  ...
  const fetchEventCategories = async () => {
    ...
    try {
      ...
      const productCategoriesRes = api.get("/api/product/category");
  ...
  const handleDeactivate = async (product_id) => {
    try {
      const response = await api.patch(
        `api/product/category/${product_id}/deactivate/`
      );
  ...
  const handleActivate = async (product_id) => {
    try {
      const response = await api.patch(
        `api/product/category/${product_id}/activate/`
      );
