        ...
        <div className="container mt-4">
          {loading ? (
            <div className="d-flex justify-content-center">
              <Spinner />
              <h4 className="text-warning ms-3">Loading Services...</h4>
            </div>
          ) : service ? (
            <main class="container">
              <div class="row g-5">
                <div class="col-md-12">
                  <article className="services-post p-4 border rounded shadow-sm">
                    <div className="d-flex justify-content-between align-items-center mb-3">
                      <div>
                        <h2 className="display-5 fw-bold mb-1">
                          {service.name}
                        </h2>
                        <p className="services-post-meta text-muted mb-0">
                    ...
                    <div
                      ...
                      dangerouslySetInnerHTML={{ __html: service.descriception }}
